...
- **Shri Ram Shalaka Prashnavali** - 15x15 interactive divination grid
...
| Security | Arcjet (rate limiting + bot detection + WAF), Zod validation, 7 security headers (CSP, HSTS, etc.) |
